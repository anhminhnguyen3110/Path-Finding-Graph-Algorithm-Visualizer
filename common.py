...
def print_path_multidirection(intersect_start, intersect_end, path, start, end: list, instructions_start, instructions_end):
	ans = []
...
def print_path_multidirection_astar(intersect_node, path_start, path_end, start, end, instructions_start, instructions_end):
	ans = []
